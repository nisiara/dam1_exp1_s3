...
## ⭐ Características
- Registro de datos del tutor: nombre, teléfono y correo con validación de formato.
...
│  ├─ Veterinaria.kt               # Lógica principal del flujo y utilidades
│  └─ model/
│     ├─ Usuario.kt                
│     ├─ Veterinario.kt            
│     ├─ Tutor.kt                  
...
## ✏️ Requisitos
- JDK 17 o superior (se recomienda 17/21).
- IntelliJ IDEA
